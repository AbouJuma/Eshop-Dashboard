...
<style>
    ...
    .create-service-card .card-header {
        background: #ffffff;
        border-bottom: 1px solid #f1f5f9;
        padding: 20px 24px;
    }

    .create-service-card .card-title {
        font-size: 16px;
        font-weight: 700;
        color: #0f172a;
        margin: 0;
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2 align-items-center">
            <div class="col-sm-6">
                <h1 class="m-0 font-weight-bold" style="color: #0f172a; letter-spacing: -0.5px;">Create Service</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right" style="background: transparent; padding: 0; margin: 0;">
                    ...
                    <li class="breadcrumb-item active" style="color: #0f172a; font-weight: 600;">Create</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row" style="text-align: center; display: block;">
            <div class="col-md-8" style="display: inline-block; float: none; text-align: left;">
                <div class="card create-service-card">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-plus-circle text-muted mr-2"></i>Service Information</h3>
                    </div>
                        ...
                        <div class="card-body p-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                       id="title" name="title" value="{{ old('title') }}" required placeholder="e.g. Mechanical Diagnosis">
                                @error('title')
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          id="description" name="description" rows="4" placeholder="Describe the service details..."></textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                @enderror
                            </div>
...
<script>
    ...
    // Autofill old description if present
    document.addEventListener('DOMContentLoaded', function() {
        const descriptionTextarea = document.getElementById('description');
        if (descriptionTextarea) {
            descriptionTextarea.value = {!! json_encode(old('description')) !!};
        }
    });
</script>
@endpush
