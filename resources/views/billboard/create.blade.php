...
<style>
    ...
    .create-billboard-card .card-header {
        background: #ffffff;
        border-bottom: 1px solid #f1f5f9;
        padding: 20px 24px;
    }

    .create-billboard-card .card-title {
        font-size: 16px;
        font-weight: 700;
        color: #0f172a;
        margin: 0;
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2 align-items-center">
            <div class="col-sm-6">
                <h1 class="m-0 font-weight-bold" style="color: #0f172a; letter-spacing: -0.5px;">Create Billboard</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="row" style="text-align: center; display: block;">
            <div class="col-md-8" style="display: inline-block; float: none; text-align: left;">
                <div class="card create-billboard-card">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-plus-circle text-muted mr-2"></i>Billboard Information</h3>
                    </div>
                        ...
                        <div class="card-body p-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                       id="title" name="title" value="{{ old('title') }}" required placeholder="e.g. End of Season Sale 30% Off">
                                @error('title')
