...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('billboard', [\App\Http\Controllers\BillboardController::class, 'index'])->name('billboard.index');
Route::get('billboard/create', [\App\Http\Controllers\BillboardController::class, 'create'])->name('billboard.create');
Route::post('billboard', [\App\Http\Controllers\BillboardController::class, 'store'])->name('billboard.store');
Route::get('billboard/{id}/edit', [\App\Http\Controllers\BillboardController::class, 'edit'])->name('billboard.edit');
Route::put('billboard/{id}', [\App\Http\Controllers\BillboardController::class, 'update'])->name('billboard.update');
Route::delete('billboard/{id}', [\App\Http\Controllers\BillboardController::class, 'destroy'])->name('billboard.destroy');
...
Route::get('services/{id}/edit', [\App\Http\Controllers\ServicesController::class, 'edit'])->name('services.edit');
Route::put('services/{id}', [\App\Http\Controllers\ServicesController::class, 'update'])->name('services.update');
Route::delete('services/{id}', [\App\Http\Controllers\ServicesController::class, 'destroy'])->name('services.destroy');

// Sub Services routes
Route::get('sub-services', [\App\Http\Controllers\SubServicesController::class, 'index'])->name('sub-services.index');
Route::get('sub-services/create', [\App\Http\Controllers\SubServicesController::class, 'create'])->name('sub-services.create');
Route::post('sub-services', [\App\Http\Controllers\SubServicesController::class, 'store'])->name('sub-services.store');
Route::get('sub-services/{id}/edit', [\App\Http\Controllers\SubServicesController::class, 'edit'])->name('sub-services.edit');
Route::put('sub-services/{id}', [\App\Http\Controllers\SubServicesController::class, 'update'])->name('sub-services.update');
Route::delete('sub-services/{id}', [\App\Http\Controllers\SubServicesController::class, 'destroy'])->name('sub-services.destroy');
Route::get('sub-services/get-models/{makeId}', [\App\Http\Controllers\SubServicesController::class, 'getModelsByMake']);
Route::get('service-prices', [\App\Http\Controllers\ServicePricesController::class, 'index'])->name('service-prices.index');
Route::post('service-prices', [\App\Http\Controllers\ServicePricesController::class, 'store'])->name('service-prices.store');
Route::put('service-prices/{id}', [\App\Http\Controllers\ServicePricesController::class, 'update'])->name('service-prices.update');
Route::delete('service-prices/{id}', [\App\Http\Controllers\ServicePricesController::class, 'destroy'])->name('service-prices.destroy');
Route::get('booking', [\App\Http\Controllers\BookingViewController::class, 'index'])->name('booking.index');
Route::post('booking/{id}/update-status', [\App\Http\Controllers\BookingViewController::class, 'updateStatus'])->name('booking.update-status');
Route::post('booking/{id}/update-price', [\App\Http\Controllers\BookingViewController::class, 'updatePrice'])->name('booking.update-price');

// Shop routes
Route::get('orders', [\App\Http\Controllers\OrdersController::class, 'index'])->name('orders.index');
Route::get('orders/{id}/details', [\App\Http\Controllers\OrdersController::class, 'getOrderDetails'])->name('orders.details');
Route::post('orders/{id}/update-status', [\App\Http\Controllers\OrdersController::class, 'updateStatus'])->name('orders.update-status');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/home/get-dashboard-stats', [App\Http\Controllers\HomeController::class, 'getDashboardStats']);
});
